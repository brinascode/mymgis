...
$scope.accType=""
	...
	$scope.setAccTypeF = function(){
			if(confirm("Setting your account to Teacher is irreversible. If you are a student, you may be" + 
				" sanctioned for carrying this operation. Do you really want to set your account to Teacher?")){
				userModifs.setUserType($scope)
			}
	...
	$scope.nomCompletNew
		$scope.newNomComplet = function(){
			...
			userModifs.newFullName($scope,$scope.nomCompletNew)
