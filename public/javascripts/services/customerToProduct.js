...
return {
	...
	//Page produit === Class Page
	getClass:function($scope,$routeParams){
		//Get the class info for the page :)
		//Is http post the best way to do this?
		$http.post("/findClass",$routeParams).success(function(data){
			$scope.Class = data //Data is an array now
